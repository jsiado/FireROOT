...
DATASET_BKG = join(os.getenv("CMSSW_BASE"), "src/FireROOT/Analysis/python/samples/latest/skimmed_backgrounds.json")
DATASET_DATA = join(os.getenv("CMSSW_BASE"), "src/FireROOT/Analysis/python/samples/latest/skimmed_control_data2018.json")
SCALE_BKG = join(os.getenv("CMSSW_BASE"), "src/FireROOT/Analysis/python/samples/latest/skimmed_backgrounds_scale.json")

DATASET_SIG_4MU = join(os.getenv('CMSSW_BASE'), 'src/FireROOT/Analysis/python/samples/latest/signal_4mu.json')
DATASET_SIG_2MU2E = join(os.getenv('CMSSW_BASE'), 'src/FireROOT/Analysis/python/samples/latest/signal_2mu2e.json')
SCALE_SIG_4MU = join(os.getenv('CMSSW_BASE'), 'src/FireROOT/Analysis/python/samples/latest/signal_4mu_scale.json')
SCALE_SIG_2MU2E = join(os.getenv('CMSSW_BASE'), 'src/FireROOT/Analysis/python/samples/latest/signal_2mu2e_scale.json')
