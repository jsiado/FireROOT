...
def ch4muEff():        
        eff1 = TEfficiency("eff1", "eff def", 10, 0,0.5, 10, 0, 1.4)
...
if __name__ == "__main__":
    ...
    path = "~/nobackup/SIDM_ana/Analysis/CMSSW_10_2_14/src/FireROOT/Analysis/python/outputs/rootfiles/modules/ch2mu2eTrEff.root"
