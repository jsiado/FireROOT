void myeff_ptvsdR()
{
    ...
    leg_ptdR->Draw();
    can_ptdR -> SaveAs("../outputs/plots/modules/genTriggerEfficiency/central_ptvsdR.pdf");
    ...
    leg_ptdRlxy->Draw();
    can_ptdRlxy->SaveAs("../outputs/plots/modules/genTriggerEfficiency/central_ptvsdRlxy.pdf");
}
