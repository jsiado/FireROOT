...
void myeff_trioverlap(int num)
{
    ...
    eff_s1t6->Draw();
    cs1 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf",num, S1));
    ...
    legs1tall->Draw();
    cans1tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf",num, S1));
    ...
    eff_s2t6->Draw();
    cs2 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf",num, S2));
    ...
    legs2tall->Draw();
    cans2tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf",num,S2));
  ...
  //Third sample mXX-500_mA-0p25_lxy-300
    ...
    eff_s3t6->Draw();
    cs3 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf",num,S3));
    ...
    legs3tall->Draw();
    cans3tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf",num,S3));
    ...
    eff_s4t6->Draw();
    cs4 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf",num ,S4));
    ...
    legs4tall->Draw();
    cans4tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S4));
    ...
    eff_s5t6->Draw();
    cs5 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf", num,S5));
    ...
    legs5tall->Draw();
    cans5tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S5));
    ...
    eff_s6t6->Draw();
    cs6 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf", num,S6));
    ...
    legs6tall->Draw();
    cans6tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S6));
    ...
    eff_s7t6->Draw();
    cs7->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf", num,S7));
    ...
    legs7tall->Draw();
    cans7tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S7));
    ...
    eff_s8t6->Draw();
    cs8 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf", num,S8));
    ...
    legs8tall->Draw();
    cans8tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S8));
    ...
    eff_s9t6->Draw();
    cs9 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf", num,S9));
    ...
    legs9tall->Draw();
    cans9tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S9));
    ...
    eff_s0t6->Draw();
    cs0 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_can.pdf", num,S0));
    ...
    legs0tall->Draw();
    cans0tall -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_%s_all.pdf", num,S0));
    ...
    legsallt1->Draw();
    cansallt1 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_all_%s.pdf", num,T1));
    ...
    legsallt2->Draw();
    cansallt2 -> SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_all_%s.pdf", num,T2));    
}
