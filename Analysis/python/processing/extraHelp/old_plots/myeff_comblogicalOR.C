...
void myeff_comblogicalOR(int num)
{
  ...
  //triggers
    ...
    eff_comb_num1->SetTitle("Efficiency: Logical OR combined; #Delta R; Efficiency");
    ...
    cs1->SaveAs("../outputs/plots/modules/genTriggerEfficiency2mu/001_central_LogicalOR_comb.pdf");
