void f1_ch2mu2e_dR(const char *date, const char *samp)
{	
//	cout<<date<<endl;
...
//{
	...
	leg_f1->Draw();    
	can_f1->SaveAs(Form("../outputs/plots/modules/ch2mu2eTrEff/eff_%s_dR_%s.pdf",date,samp));
	can_f1->SaveAs(Form("../outputs/plots/modules/ch2mu2eTrEff/eff_%s_dR_%s.png",date,samp));
}
