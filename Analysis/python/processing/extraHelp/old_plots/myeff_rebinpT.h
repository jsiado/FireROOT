void myeff_rebinpT(int num)
{
  ...
  //triggers.... not used here, switch to Logical OR
    ...
    TH1F *alldimu_1 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S1));
    TH1F *alldimu_2 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S2));
    TH1F *alldimu_3 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S3));
  	TH1F *alldimu_4 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S4));
    TH1F *alldimu_5 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S5));
    TH1F *alldimu_6 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S6));
    TH1F *alldimu_7 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S7));
    TH1F *alldimu_8 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S8));
    TH1F *alldimu_9 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S9));
    TH1F *alldimu_0 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt3b",S0));

	//All samples with Logical OR
    TH1F *dimu_s1tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S1));    TH1F *eff_s1tor = (TH1F*) dimu_s1tor->Clone();    
    TH1F *dimu_s2tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S2));    TH1F *eff_s2tor = (TH1F*) dimu_s2tor->Clone();
    TH1F *dimu_s3tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S3));    TH1F *eff_s3tor = (TH1F*) dimu_s3tor->Clone();
    TH1F *dimu_s4tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S4));    TH1F *eff_s4tor = (TH1F*) dimu_s4tor->Clone();
    TH1F *dimu_s5tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S5));    TH1F *eff_s5tor = (TH1F*) dimu_s5tor->Clone();
    TH1F *dimu_s6tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S6));    TH1F *eff_s6tor = (TH1F*) dimu_s6tor->Clone();
    TH1F *dimu_s7tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S7));    TH1F *eff_s7tor = (TH1F*) dimu_s7tor->Clone();
    TH1F *dimu_s8tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S8));    TH1F *eff_s8tor = (TH1F*) dimu_s8tor->Clone();
    TH1F *dimu_s9tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S9));    TH1F *eff_s9tor = (TH1F*) dimu_s9tor->Clone();
   	TH1F *dimu_s0tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt3b",S0));    TH1F *eff_s0tor = (TH1F*) dimu_s0tor->Clone();
	...
	/*TCanvas *can_LORpt3b = new TCanvas("can_LORpt3b","",1800,800);
    can_LORpt->Divide(3,2);    
    can_LORpt->cd(1);    
    eff_s1tor->SetLineColor(kBlack);    
    eff_s1tor->SetMarkerColor(kBlack);    
    eff_s1tor->SetMarkerStyle(20);    
    eff_s1tor->SetStats(kFALSE);    
    eff_s1tor->SetTitle(Form("Efficiency: %s; p_{T} [GeV]; Efficiency",S1));    
    eff_s1tor->Draw();    
    can_LORpt->cd(2);    
    ...
    eff_s2tor->SetTitle(Form("Efficiency: %s; p_{T} [GeV]; Efficiency",S2));    
    eff_s2tor->Draw();    
    can_LORpt->cd(3);    
    ...
    eff_s3tor->SetTitle(Form("Efficiency: %s; p_{T} [GeV]; Efficiency",S3));    
    eff_s3tor->Draw();
    can_LORpt->cd(4);    
    ...
    eff_s4tor->SetTitle(Form("Efficiency: %s; p_{T} [GeV]; Efficiency",S4));    
    eff_s4tor->Draw();
    can_LORpt->cd(5);    
    ...
    eff_s5tor->SetTitle(Form("Efficiency: %s; p_{T} [GeV]; Efficiency",S5));    
    eff_s5tor->Draw();
    can_LORpt->cd(6);    
    ...
    eff_s6tor->SetTitle(Form("Efficiency: %s; p_{T} [GeV]; Efficiency",S6));    
    eff_s6tor->Draw();    
    can_LORpt->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_pTLogicalOR_can.pdf",num));*/
    ...
    TCanvas* can_LORallpt3b = new TCanvas("can_LORallpt3b");  
    eff_s1tor->SetTitle("Efficiency: all samples rebinned; p_{T} [GeV]; Efficiency");
    eff_s1tor->SetStats(kFALSE);
    ...
    legtorall->Draw();
    can_LORallpt3b->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_pTLogicalOR3b_all.pdf",num));
    
    TCanvas* can_LORlxypt3b = new TCanvas("can_LORlxypt3b");  
    eff_s1tor->SetTitle("Efficiency: Different l_xy rebinned; p_{T} [GeV]; Efficiency");
    eff_s1tor->SetStats(kFALSE);
    eff_s1tor->SetAxisRange(0.0,1.0,"Y");
    eff_s1tor->Draw();
    eff_s4tor->Draw("same");
    ...
    legtorlxy->Draw();
    can_LORlxypt3b->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_pTLogicalOR3b_lxy.pdf",num));
}
