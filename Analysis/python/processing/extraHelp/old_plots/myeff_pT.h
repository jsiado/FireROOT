void myeff_pT(int date, const char *muon)
{
  ...
  //triggers.... not used here, switch to Logical OR
    ...
    TH1F *alldimu_1 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S1));
    TH1F *alldimu_2 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S2));
    TH1F *alldimu_3 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S3));
  	TH1F *alldimu_4 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S4));
    TH1F *alldimu_5 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S5));
    TH1F *alldimu_6 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S6));
    TH1F *alldimu_7 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S7));
    TH1F *alldimu_8 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S8));
    TH1F *alldimu_9 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S9));
    TH1F *alldimu_0 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_lpT",S0));

	//All samples with Logical OR
    TH1F *dimu_s1tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S1));    TH1F *eff_s1tor = (TH1F*) dimu_s1tor->Clone();    
    TH1F *dimu_s2tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S2));    TH1F *eff_s2tor = (TH1F*) dimu_s2tor->Clone();
    TH1F *dimu_s3tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S3));    TH1F *eff_s3tor = (TH1F*) dimu_s3tor->Clone();
    TH1F *dimu_s4tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S4));    TH1F *eff_s4tor = (TH1F*) dimu_s4tor->Clone();
    TH1F *dimu_s5tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S5));    TH1F *eff_s5tor = (TH1F*) dimu_s5tor->Clone();
    TH1F *dimu_s6tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S6));    TH1F *eff_s6tor = (TH1F*) dimu_s6tor->Clone();
    TH1F *dimu_s7tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S7));    TH1F *eff_s7tor = (TH1F*) dimu_s7tor->Clone();
    TH1F *dimu_s8tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S8));    TH1F *eff_s8tor = (TH1F*) dimu_s8tor->Clone();
    TH1F *dimu_s9tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S9));    TH1F *eff_s9tor = (TH1F*) dimu_s9tor->Clone();
   	TH1F *dimu_s0tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORlpT",S0));    TH1F *eff_s0tor = (TH1F*) dimu_s0tor->Clone();
    ...
    /*TCanvas *can_LORpt = new TCanvas("can_LORpt","",1800,800);
	...
	TCanvas* can_LORallpt = new TCanvas("can_LORallpt"); 
    eff_s1tor->SetTitle(Form("Efficiency: %s muons; p_{T} [GeV]; Efficiency []",muon)); 
    //eff_s1tor->SetTitle("Efficiency: all samples; p_{T} [GeV]; Efficiency");
	eff_s1tor->SetStats(kFALSE);
	...
	legtorall->Draw();
	can_LORallpt->SaveAs(Form("../outputs/plots/modules/TrEff2mu/%i_%s_pT.pdf",date,muon));
    
	TCanvas* can_LORlxypt = new TCanvas("can_LORlxypt");  
	//eff_s1tor->SetTitle(Form("Efficiency: Different l_{xy}; p_{T} [GeV]; Efficiency");
    eff_s1tor->SetTitle(Form("Efficiency: %s muons; p_{T} [GeV]; Efficiency",muon));  
    eff_s1tor->SetStats(kFALSE);
    eff_s1tor->SetAxisRange(0.0,1.0,"Y");
    eff_s1tor->Draw();
    ...
    legtorlxy->Draw();
    can_LORlxypt->SaveAs(Form("../outputs/plots/modules/TrEff2mu/%i_%s_pTlxy.pdf",date,muon));
}
