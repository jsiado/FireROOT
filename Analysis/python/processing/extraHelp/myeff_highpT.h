void myeff_highpT(int num)
{
  ...
  //triggers.... not used here, switch to Logical OR
    ...
    TH1F *alldimu_1 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S1));
    TH1F *alldimu_2 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S2));
    TH1F *alldimu_3 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S3));
  	TH1F *alldimu_4 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S4));
    TH1F *alldimu_5 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S5));
    TH1F *alldimu_6 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S6));
    TH1F *alldimu_7 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S7));
    TH1F *alldimu_8 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S8));
    TH1F *alldimu_9 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S9));
    TH1F *alldimu_0 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_pt",S0));

	//All samples with Logical OR
    TH1F *dimu_s1tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S1));    TH1F *eff_s1tor = (TH1F*) dimu_s1tor->Clone();    
    TH1F *dimu_s2tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S2));    TH1F *eff_s2tor = (TH1F*) dimu_s2tor->Clone();
    TH1F *dimu_s3tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S3));    TH1F *eff_s3tor = (TH1F*) dimu_s3tor->Clone();
    TH1F *dimu_s4tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S4));    TH1F *eff_s4tor = (TH1F*) dimu_s4tor->Clone();
    TH1F *dimu_s5tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S5));    TH1F *eff_s5tor = (TH1F*) dimu_s5tor->Clone();
    TH1F *dimu_s6tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S6));    TH1F *eff_s6tor = (TH1F*) dimu_s6tor->Clone();
    TH1F *dimu_s7tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S7));    TH1F *eff_s7tor = (TH1F*) dimu_s7tor->Clone();
    TH1F *dimu_s8tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S8));    TH1F *eff_s8tor = (TH1F*) dimu_s8tor->Clone();
    TH1F *dimu_s9tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S9));    TH1F *eff_s9tor = (TH1F*) dimu_s9tor->Clone();
   	TH1F *dimu_s0tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORpt",S0));    TH1F *eff_s0tor = (TH1F*) dimu_s0tor->Clone();
    ...
    legtorall->Draw();
    can_LORallpt->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_pTLogicalOR_all.pdf",num));
    
    TCanvas* can_LORlxypt = new TCanvas("can_LORlxypt");  
    eff_s1tor->SetTitle("Efficiency: Different l_{xy}; p_{T} [GeV]; Efficiency");
    eff_s1tor->SetStats(kFALSE);
    eff_s1tor->SetAxisRange(0.0,1.0,"Y");
    eff_s1tor->Draw();
	eff_s4tor->Draw("same");
    ...
    legtorlxy->Draw();
    can_LORlxypt->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_pTLogicalOR_lxy.pdf",num));
}
