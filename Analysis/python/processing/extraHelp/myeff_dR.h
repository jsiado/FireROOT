void myeff_dR(int date, const char *muon)
{
	//char C[10] = "dsa";
  ...
  //triggers
	...
	TH1F *alldimu_1 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S1));
	TH1F *alldimu_2 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S2));
	TH1F *alldimu_3 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S3));
	TH1F *alldimu_4 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S4));
	TH1F *alldimu_5 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S5));
	TH1F *alldimu_6 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S6));
	TH1F *alldimu_7 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S7));
	TH1F *alldimu_8 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S8));
	TH1F *alldimu_9 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S9));
	TH1F *alldimu_0 = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_dR",S0));

	//TH1F *comb = new TH1F("comb","Comb","")

    //All samples with Logical OR
	TH1F *dimu_s1tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S1));    TH1F *eff_s1tor = (TH1F*) dimu_s1tor->Clone();    
	TH1F *dimu_s2tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S2));    TH1F *eff_s2tor = (TH1F*) dimu_s2tor->Clone();
	TH1F *dimu_s3tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S3));    TH1F *eff_s3tor = (TH1F*) dimu_s3tor->Clone();
	TH1F *dimu_s4tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S4));    TH1F *eff_s4tor = (TH1F*) dimu_s4tor->Clone();
	TH1F *dimu_s5tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S5));    TH1F *eff_s5tor = (TH1F*) dimu_s5tor->Clone();
	TH1F *dimu_s6tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S6));    TH1F *eff_s6tor = (TH1F*) dimu_s6tor->Clone();
	TH1F *dimu_s7tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S7));    TH1F *eff_s7tor = (TH1F*) dimu_s7tor->Clone();
	TH1F *dimu_s8tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S8));    TH1F *eff_s8tor = (TH1F*) dimu_s8tor->Clone();
	TH1F *dimu_s9tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S9));    TH1F *eff_s9tor = (TH1F*) dimu_s9tor->Clone();
	TH1F *dimu_s0tor = (TH1F*)file_1->Get(Form("ch2mu2e/sig/%s/allDimu_ORdR",S0));    TH1F *eff_s0tor = (TH1F*) dimu_s0tor->Clone();
    ...
    eff_s1tor->SetTitle(Form("Efficiency: %s; #Delta R; Efficiency",S1));    
    eff_s1tor->Draw();    
    can_LOR->cd(2);    
    ...
    eff_s2tor->SetTitle(Form("Efficiency: %s; #Delta R; Efficiency",S2));    
    eff_s2tor->Draw();
    can_LOR->cd(3);
    ...
    eff_s4tor->SetTitle(Form("Efficiency: %s; #Delta R; Efficiency",S4));    
    eff_s4tor->Draw();
    can_LOR->cd(5);
    ...
    eff_s5tor->SetTitle(Form("Efficiency: %s; #Delta R; Efficiency",S5));    
    eff_s5tor->Draw();
    can_LOR->cd(6);    
    ...
    eff_s6tor->SetTitle(Form("Efficiency: %s; #Delta R; Efficiency",S6));    
    eff_s6tor->Draw();    
    can_LOR->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_LogicalOR_can.pdf",num));*/
    ...
    eff_s1tor->SetTitle(Form("Efficiency: %s muons; #Delta R; Efficiency",muon));
    eff_s1tor->SetStats(kFALSE);
    ...
    legtorall->Draw();
    can_LORall->SaveAs(Form("../outputs/plots/modules/TrEff2mu/%i_%s_dR.pdf",date,muon));
    ...
    legtorlxy->Draw();
    can_LORlxy->SaveAs(Form("../outputs/plots/modules/TrEff2mu/%i_%s_dRlxy.pdf",date,muon));
}
