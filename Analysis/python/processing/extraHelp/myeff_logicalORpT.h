void myeff_logicalOR(int num)
{
  ...
  //triggers
    ...
    legtorall->Draw();
    can_LORall->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_LogicalOR_all.pdf",num));
    ...
    legtorlxy->Draw();
    can_LORlxy->SaveAs(Form("../outputs/plots/modules/genTriggerEfficiency2mu/%i_LogicalOR_lxy.pdf",num));
}
