void f1_ch2mu2e_eta(const char *date)
{	
//	cout<<date<<endl;
...
//{
    ...
    //if (ii == 4){ 
	eff_s1->SetTitle("Efficiency: muon #eta; #eta; Efficiency");
	...
	leg_f1->Draw();
	can_eta->SaveAs(Form("../outputs/plots/modules/ch2mu2eTrEff/eff_%s_eta.pdf",date));
	can_eta->SaveAs(Form("../outputs/plots/modules/ch2mu2eTrEff/eff_%s_eta.png",date));
}
