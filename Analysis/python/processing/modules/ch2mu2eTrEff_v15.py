...
Eff = gen-mathed reco muons matched to TO / gen-matched reco muons... Using the ljsources collection
'''
...
histCollection = [
    ...
    { 'name': 'diff1_pT',          'binning': (100, -10,10),              'title': 'p_{T} diff of leading muons; |p_{T}^{gen} - p_{T}^{reco} |/p_{T}^{gen} [GeV]; Events'},
    { 'name': 'diff2_pT',          'binning': (100, -10,10),              'title': 'p_{T} diff of sub-leading muons; 1- #fract{p_T}{t_p} ; Events'},
    #{ 'name': 'gen_diff_pT',      'binning': (100, 0.,800.),               'title': 'p_{T} diff of gen muons; |p_{T}^{lead} - p_{T}^{sub}| [GeV]; Events'},

    { 'name': 'Passed_ID',         'binning': (80, 0,800),                 'title': '; p_{T} [GeV]; Entries'},
    { 'name': 'Total_ID',          'binning': (80, 0,800),                 'title': '; p_{T} [GeV]; Entries'},
    ...
    { 'name': 'Passed_dR',         'binning': [[0,.005,.01,.015,.02,.025,.03,.04,.05,.06,.07,.08,.09,.1,.12,.14,.16,.18,.2,.24,.28, 0.35]],   'title': '#Delta R (to,reco); #Delta R; Entries'},
    { 'name': 'Total_dR',          'binning': [[0,.005,.01,.015,.02,.025,.03,.04,.05,.06,.07,.08,.09,.1,.12,.14,.16,.18,.2,.24,.28, 0.35]],   'title': '#Delta R (to,reco); #Delta R; Entries'},
    ...
    { 'name': 'Passed_zdpt',       'binning': (80, 0., 1200.),             'title': '; Dark photon p_{T}; #eta; Entries'},
    { 'name': 'Total_zdpt',        'binning': (80, 0., 1200.),             'title': '; Dark photon p_{T}; Entries'},
    { 'name': 'Passed_zdlxy',      'binning': (80, 0., 1200.),             'title': '; Dark photon L_{xy} [cm]; Entries'},
    { 'name': 'Total_zdlxy',       'binning': (80, 0., 1200.),             'title': '; Dark photon L_{xy} [cm]; Entries'},
