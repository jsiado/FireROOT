...
class MyEvents(SignalEvents):
    ...
    def processEvent(self, event, aux):
        ...
        #print len(Reco_Mu)
        #DimuTri = ["DoubleL2Mu23NoVtx_2Cha", "DoubleL2Mu23NoVtx_2Cha_NoL2Matched", "DoubleL2Mu23NoVtx_2Cha_CosmicSeed", "DoubleL2Mu23NoVtx_2Cha_CosmicSeed_NoL2Matched", "DoubleL2Mu25NoVtx_2Cha_Eta2p4", "DoubleL2Mu25NoVtx_2Cha_CosmicSeed_Eta2p4"]
...
histCollection = [
    ...
    {  'name': 'TO_pT',	       'binning' : (100, 0.0, 500.0),			'title': 'Trigger object p_{t}; p_{T}; number of entries'},
