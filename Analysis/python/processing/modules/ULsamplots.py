...
histCollection = [
    ...
    {'name': 'dplxy',         'binning': (100, 0, 800),         'title': 'darkphoton lxy;Lxy [cm];counts/1cm'},
    {'name': 'MuPt',          'binning': (100, 0, 500.0),       'title': 'all Muons;p_{T} [GeV]; counts'    },
    {'name': 'psmass',        'binning': (100, 0, 1100.0),      'title': 'dark photon mass;p_{T} [GeV]; counts'    },
    {'name': 'dpdphi',        'binning': (100, -3.5, 3.5),      'title': '#Delta#phi;p_{T} [GeV]; counts'    },
