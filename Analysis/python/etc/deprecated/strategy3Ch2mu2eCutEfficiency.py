...
fn = os.path.join(os.getenv('CMSSW_BASE'), 'src/FireROOT/Analysis/python/outputs/rootfiles/strategy3_ch2mu2e.root')
outdir = os.path.join(os.getenv('CMSSW_BASE'), 'src/FireROOT/Analysis/python/etc/plots/strategy3Ch2mu2eCutEfficiency')
...
# routine('2mu2e', 'dphi_e', 'forward', 24, 'lepton-jet pair |#Delta#phi|')
# routine('2mu2e', 'ljetaabssum', 'backward', 25, 'lepton-jet |#eta_{0}+#eta_{1}|')
# routine('2mu2e', 'maxljiso', 'backward', 24, 'max lepton-jet isolation')

routine('2mu2e', 'scaledd0', 'forward', 16, 'muon-type lepton-jet scaled d0')
f.close()